...
export class TraceViewerPanel {
    ...
    private _functionExplanations: Map<string, string> = new Map();

    private constructor(panel: vscode.WebviewPanel, extensionUri: vscode.Uri, trace: Trace, explanations: Map<string, string>) {
        this._panel = panel;
    ...
    public static createOrShow(extensionUri: vscode.Uri, trace: Trace, explanations: Map<string, string>) {
