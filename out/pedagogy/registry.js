...
exports.findPedagogyByApproach = exports.findPedagogy = exports.PEDAGOGICAL_TYPES = void 0;
...
function findPedagogy(type) {
    return exports.PEDAGOGICAL_TYPES.find(p => p.type === type);
}
exports.findPedagogy = findPedagogy;
/**
 ...
 */
function findPedagogyByApproach(approach, dimension) {
    const def = exports.PEDAGOGICAL_TYPES.find(p => p.approach === approach && p.dimension === dimension);
    if (!def) {
        throw new Error(`No pedagogy registered for approach="${approach}" dimension="${dimension}"`);
    }
    return def;
}
exports.findPedagogyByApproach = findPedagogyByApproach;
